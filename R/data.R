...
#' \describe{
#'   \item{county_ua_19_name}{County or Unitary Authority name}
#'   \item{county_ua_19_code}{County or Unitary Authority code}
...
#' @format A data frame of class "tbl" with 173 rows and 94 variables:
#' \describe{
#'   \item{county_ua_20_name}{County or Unitary Authority name}
#'   \item{county_ua_20_code}{County or Unitary Authority code}
#'   \item{total_population}{Total number of people living in each area}
#'   \item{`0`:`90+`}{Number of people in each single age group}
#'   ...
#' }
